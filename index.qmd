...
That support rarely follows a simple pattern. It is shaped by **ideological and partisan biases** — scepticism runs markedly higher among right-wing and, especially, far-right voters, for whom climate regulation is often framed as a threat to individual freedom. It is shaped by **distributive concerns** — citizens who bear a policy's costs directly, or see it as unfair to lower-income households, are far more likely to oppose it, as seen in backlashes such as France's "yellow vest" protests against carbon taxation. And it is shaped by **proximity** — even citizens who endorse climate action in the abstract often resist concrete measures that touch their own street or daily routine, the classic pattern of NIMBY-style opposition. These biases also interact with economic shocks, generational change, and shifting party loyalties, which can harden or soften climate attitudes well after a policy is first proposed.

Understanding these dynamics is not just an academic exercise. ATTClimate and ATTCLIMPOLS aim to generate actionable knowledge for policymakers — identifying which policy designs attract broad support, which groups are most likely to resist a given measure and why, and how governments can anticipate backlash before it derails a policy's implementation. The programme also treats its data as a public good: the resulting panel survey is among the largest and longest-running of its kind in the world, and is made freely available to the research community.
...
<p>ATTCLIMATE investigated how Spanish citizens form beliefs about climate change and decide whether to support the policies designed to address it. Tracking the same individuals across four waves allowed genuine within-person analysis of how attitudes shift in response to real-world events — including the October 2024 DANA floods — rather than relying on snapshot comparisons across different people. The project substantially exceeded its original scope, expanding from a single planned survey and three papers to four panel waves and more than five active lines of research, while training two PhD students working on climate attitudes.</p>
:::
...
<p>ATTCLIMPOLS pursues five interconnected research lines: improving global climate-attitude data and its comparability; tracking within-individual change in beliefs and policy support as economic conditions, ideology and generational composition shift; estimating how much citizens are willing to trade off in income for better climate and environmental conditions; and examining the electoral consequences of contested environmental policies such as door-to-door waste collection. Together, these lines aim to identify not just whether citizens support climate action, but under what conditions that support holds.</p>
:::
:::::
...
::: {.rl-card .surface-card}
<p><strong>Quality data for climate research.</strong> A harmonised, cross-country database of climate attitudes covering 100+ countries, providing a robust empirical foundation for climate change research worldwide.</p>
:::
...
::: {.rl-card .surface-card}
<p><strong>We're hiring!</strong> We're looking for a PhD candidate to join the ATTCLIMPOLS project on political attitudes &amp; climate change, at the Dept. of Political Science and Public Law, Universitat Autònoma de Barcelona.</p>
<p>Deadline for expressions of interest: <strong>October 2, 2026</strong>.</p>
<p><a href="https://uab-my.sharepoint.com/:b:/g/personal/1407091_uab_cat/IQC2LyBmmTMtRaNIbiYvn9LLAadCPsZpnhwD52fhKK2xROg?e=6pFd4e" target="_blank" rel="noopener">Full call information (PDF)</a> · CV, motivation letter, writing sample &amp; 2 references (1 PDF) → <a href="mailto:marc.guinjoanc@uab.cat?subject=PhD%20ATTCLIMPOLS">marc.guinjoanc@uab.cat</a> (subject "PhD ATTCLIMPOLS")</p>
<p>Follow us on social media for more information:<br>
...
ATTClimate has fielded four waves of original survey data (2023–2025) among the Spanish population, accumulating over 15,000 respondent-wave observations, with at least three further waves planned under ATTCLIMPOLS (2026–2029). All harmonised data are available through the [CORA research data repository](https://doi.org/10.34810/DATA3567) — see the [Attclimate dataset](data_en.qmd) page for details. You can also explore the survey data interactively via the [Panel data analysis](https://mguinjoan.shinyapps.io/attclimate/) app.
